...
private static readonly char[] s_Diacritics = GetDiacritics();
	...
	public static string RemoveAllAnnoyingCharacters (string text, bool allowSpace) {
		string textToReturn;
		textToReturn = RemoveDiacritics(text);
		textToReturn = RemoveSpecialCharacters(textToReturn, allowSpace);
